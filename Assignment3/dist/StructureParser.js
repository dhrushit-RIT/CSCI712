        ...
        switch (parts[0]) {
            ...
            case "OFFSET":
                ...
                if (!skeletonParts[currentPart].isRoot) {
                    let limbLength = Math.sqrt(offset.x * offset.x + offset.y * offset.y + offset.z * offset.z);
                    let limb = new Limb(limbLength, 0.5);
                    const axis = new THREE.Vector3(0, 1, 0);
                    limb.setPosition(new THREE.Vector3(offset.x / 2, offset.y / 2, offset.z / 2));
                    limb.quaternion.setFromUnitVectors(axis, offsetVector.clone().normalize());
...
function parseOffset(offsetStringArr) {
...
//# sourceMappingURL=StructureParser.js.map